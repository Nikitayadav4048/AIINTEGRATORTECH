        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Intelligent automation solutions powered by artificial intelligence and machine learning.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-800">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Get AI-powered solutions that automate processes and drive intelligent decision-making.
          </p>
