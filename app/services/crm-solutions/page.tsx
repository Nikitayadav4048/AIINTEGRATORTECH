        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Smart Customer Relationship Management tools to track leads, manage clients, and boost sales efficiency.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-800">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Get a custom CRM system that helps you manage customers and increase revenue.
          </p>
